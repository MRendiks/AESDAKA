    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-dark sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="../dashboard/index.php">
                ...
                <div class="sidebar-brand-text mx-3">AESDAKA</div>
            </a>
            <!-- Divider -->
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    <h1 class="h4 mb-0 ml-2 text-gray-800">Tentang Aplikasi - Implementasi Metode Enkripsi AES 128 Bit pada Data Karyawan</h1>
                ...
                <div class="container-fluid">
                    <div class="alert alert-success" role="alert">
                        ...
                        Implementasi Metode Enkripsi AES 128 Bit pada Data Karyawan - Tentang Aplikasi
                    </div>
                    <div class="col-md-12">
                        <div class="card shadow mb-4">
                            ...
                            <div class="card-body">
                                <h5>Implementasi Metode Enkripsi AES 128 Bit pada Data Karyawan</h5>
                                <br>
                                <p>Implementasi Metode Enkripsi AES 128 Bit pada Data Karyawan, bertujuan
                                    untuk meminimalisir penyalahgunaan data rahasia karyawan oleh pihak yang tidak bertanggungjawab. Metode Enkripsi
                                    AES 128 Bit digunakan untuk mengubah Data Karyawan menjadi file ciphertext atau file yang sulit untuk dimengerti makna dan isinya.
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; Implementasi Metode Enkripsi AES 128 Bit pada Data Karyawan 2022</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
