        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    <h1 class="h4 mb-0 ml-2 text-gray-800">Bantuan - Implementasi Metode Enkripsi AES 128 Bit pada Data Karyawan</h1>
                ...
                <div class="container-fluid">
                    <div class="alert alert-success" role="alert">
                        ...
                        Implementasi Metode Enkripsi AES 128 Bit pada Data Karyawan - Bantuan
                    </div>
                    <div class="col-md-12">
