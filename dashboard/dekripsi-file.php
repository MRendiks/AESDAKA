    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
          <h1 class="h4 mb-0 ml-2 text-gray-800">Dekripsi File - AESDAKA</h1>
        ...
        <div class="container-fluid">
          <div class="alert alert-success" role="alert">
            ...
            Implementasi Metode Enkripsi AES 128 Bit pada File Kependudukan - Form Dekripsi
          </div>
          <div class="row">
            <div class="col-md-12">
              <div class="card">
