        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    <h1 class="h4 mb-0 ml-2 text-gray-800">Enkripsi - Implementasi Metode Enkripsi AES 128 Bit pada Data Karyawan</h1>
                ...
                <div class="container-fluid">
                    <div class="alert alert-success" role="alert">
                        ...
                        Implementasi Metode Enkripsi AES 128 Bit pada Data Karyawan - Proses Enkripsi
                    </div>
                ...
                <footer class="sticky-footer bg-white">
                    <div class="container my-auto">
                        <div class="copyright text-center my-auto">
                            <span>Copyright &copy; AESDEKA</span>
                        </div>
                    </div>
                </footer>
                <!-- End of Footer -->
