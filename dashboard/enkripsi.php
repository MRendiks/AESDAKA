...
<head>
  ...
  <title>Enkripsi - Implementasi Metode Enkripsi AES 128 Bit pada Data Karyawan</title>
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-dark sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="../dashboard/index.php">
        ...
        <div class="sidebar-brand-text mx-3">AESDEKA</div>
      </a>
      <!-- Divider -->
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          <div class="alert alert-success" role="alert">
            ...
            Implementasi Metode Enkripsi AES 128 Bit pada Data Karyawan - Form Enkripsi
          </div>
          <div class="row">
            <div class="col-md-6">
            ...
            <div class="col-md-6">
              <div class="card shadow mb-4">
                ...
                <div class="card-body">
                  <div class="card-body">
                    <h5>Implementasi Metode Enkripsi AES 128 Bit pada File Kependudukan</h5>
